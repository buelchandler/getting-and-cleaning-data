...
---
# Introduction
This codebook is for the **Getting and Clening Data** course assignment. It is in *R Markdown* format, hence the file extension is *.Rmd*, not *.md*. Using RStudio you can execute the code listed. If you're just perusing, you should use the *CODEBOOK.html* file to read.
